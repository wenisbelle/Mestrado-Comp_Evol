...
def generate_launch_description():
    ...
    world_file = "test.sdf"  # Update to the desired world file
    ...
    # Execute Ignition Service to Unpause Simulation
    unpause_service = ExecuteProcess(
        cmd=[
            "ign", "service", 
            "-s", "/world/empty/control",  # Update "/world/empty" if your world name is different
